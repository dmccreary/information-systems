...
|---|---------|-------|--------|-------|
| 1 | Concepts | 580 | Required | Concepts from learning graph |
| 2 | Chapters | 25 | Required | Chapter directories with index.md |
| 3 | MicroSims | 44 | Recommended | Interactive simulations in docs/sims/ |
...
| 7 | Glossary Terms | 64 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 111 | Recommended | Questions in faq.md |
| 9 | Words | 268,991 | Required | Words across student-facing markdown |
...
| Equations | 5 | 2 | LaTeX expressions (inline and display) |
| Total Words | 268,991 | 217,967 | Words in markdown files |
| Links | 695 | 325 | Hyperlinks in markdown format |
| Equivalent Pages | 1108 | 904 | Estimated pages (250 words/page + visuals) |
