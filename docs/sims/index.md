---
title: List of MicroSims for Information Systems
description: A list of all the MicroSims used in the Information Systems textbook
hide:
    toc
---
...
-   **[A Digital Twin of a Wind Turbine](./digital-twin-wind-turbine/index.md)**
    ...
    <!-- ![A Digital Twin of a Wind Turbine](./digital-twin-wind-turbine/digital-twin-wind-turbine.png) -->

    A Digital Twin of a Wind Turbine

-   **[A Modern CI/CD Pipeline](./cicd-pipeline/index.md)**

    <!-- ![A Modern CI/CD Pipeline](./cicd-pipeline/cicd-pipeline.png) -->

    A Modern CI/CD Pipeline

-   **[A Modern Enterprise Network — LAN, WAN, VPN, SD-WAN, Cloud](./enterprise-network-topology/index.md)**

    <!-- ![A Modern Enterprise Network — LAN, WAN, VPN, SD-WAN, Cloud](./enterprise-network-topology/enterprise-network-topology.png) -->
...
-   **[A Simple Feature-Branch Git Workflow](./git-feature-branch-workflow/index.md)**
    ...
    <!-- ![A Simple Feature-Branch Git Workflow](./git-feature-branch-workflow/git-feature-branch-workflow.png) -->

    A Simple Feature-Branch Git Workflow

-   **[A Small Business ERD — Customer, Order, Product, Supplier](./small-business-erd/index.md)**

    <!-- ![A Small Business ERD — Customer, Order, Product, Supplier](./small-business-erd/small-business-erd.png) -->
...
-   **[A Small Project's Gantt Chart with the Critical Path Highlighted](./gantt-with-critical-path/index.md)**
    ...
    <!-- ![A Small Project's Gantt Chart with the Critical Path Highlighted](./gantt-with-critical-path/gantt-with-critical-path.png) -->
...
-   **[A Sprint Burndown Chart (Ideal vs Actual)](./sprint-burndown-chart/index.md)**
    ...
    <!-- ![A Sprint Burndown Chart (Ideal vs Actual)](./sprint-burndown-chart/sprint-burndown-chart.png) -->
...
-   **[A Value Stream Map of an Invoice-Approval Process](./value-stream-map-invoice-approval/index.md)**
    ...
    <!-- ![A Value Stream Map of an Invoice-Approval Process](./value-stream-map-invoice-approval/value-stream-map-invoice-approval.png) -->
...
-   **[An Enterprise Journey Map for a Claims Process](./journey-map-claims-process/index.md)**
    ...
    <!-- ![An Enterprise Journey Map for a Claims Process](./journey-map-claims-process/journey-map-claims-process.png) -->

    An Enterprise Journey Map for a Claims Process

-   **[Anatomy of a BPMN Order-to-Cash Process](./bpmn-order-to-cash/index.md)**

    <!-- ![Anatomy of a BPMN Order-to-Cash Process](./bpmn-order-to-cash/bpmn-order-to-cash.png) -->

    Anatomy of a BPMN Order-to-Cash Process

-   **[API Gateway Request Flow](./api-gateway-flow/index.md)**

    <!-- ![API Gateway Request Flow](./api-gateway-flow/api-gateway-flow.png) -->

    API Gateway Request Flow

-   **[As-Is vs To-Be — Manual, RPA, and Workflow Automation](./as-is-to-be-automation-comparison/index.md)**

    <!-- ![As-Is vs To-Be — Manual, RPA, and Workflow Automation](./as-is-to-be-automation-comparison/as-is-to-be-automation-comparison.png) -->
...
-   **[Bandwidth, Latency, and Throughput at a Glance](./bandwidth-latency-throughput/index.md)**
    ...
    <!-- ![Bandwidth, Latency, and Throughput at a Glance](./bandwidth-latency-throughput/bandwidth-latency-throughput.png) -->

    Bandwidth, Latency, and Throughput at a Glance

-   **[Build vs Buy vs SaaS Decision Flow](./build-buy-saas-decision/index.md)**

    <!-- ![Build vs Buy vs SaaS Decision Flow](./build-buy-saas-decision/build-buy-saas-decision.png) -->

    Build vs Buy vs SaaS Decision Flow

-   **[Container vs. Virtual Machine Architecture](./container-vs-vm-architecture/index.md)**

    <!-- ![Container vs. Virtual Machine Architecture](./container-vs-vm-architecture/container-vs-vm-architecture.png) -->

    Container vs. Virtual Machine Architecture

-   **[DIKI Hierarchy Interactive Pyramid](./diki-pyramid/index.md)**

    <!-- ![DIKI Hierarchy Interactive Pyramid](./diki-pyramid/diki-pyramid.png) -->
...
-   **[EVM Cost and Schedule Variance Visualization](./evm-variance-visualization/index.md)**
    ...
    <!-- ![EVM Cost and Schedule Variance Visualization](./evm-variance-visualization/evm-variance-visualization.png) -->

    EVM Cost and Schedule Variance Visualization

-   **[Executive IS Roles and Reporting Relationships](./is-executive-roles/index.md)**

    <!-- ![Executive IS Roles and Reporting Relationships](./is-executive-roles/is-executive-roles.png) -->
...
-   **[Mobile-First Responsive Breakpoints](./responsive-breakpoints-demo/index.md)**
    ...
    <!-- ![Mobile-First Responsive Breakpoints](./responsive-breakpoints-demo/responsive-breakpoints-demo.png) -->

    Mobile-First Responsive Breakpoints

-   **[Normalization Journey from 1NF to 3NF](./normalization-journey-1nf-to-3nf/index.md)**

    <!-- ![Normalization Journey from 1NF to 3NF](./normalization-journey-1nf-to-3nf/normalization-journey-1nf-to-3nf.png) -->

    Normalization Journey from 1NF to 3NF

-   **[Porter Value Chain with IS Overlay](./porter-value-chain/index.md)**

    <!-- ![Porter Value Chain with IS Overlay](./porter-value-chain/porter-value-chain.png) -->

    Porter Value Chain with IS Overlay

-   **[Sequence Diagram for "Place Order](./place-order-sequence-diagram/index.md)**

    <!-- ![Sequence Diagram for "Place Order](./place-order-sequence-diagram/place-order-sequence-diagram.png) -->
...
-   **[Shared Responsibility Across IaaS, PaaS, SaaS, and FaaS](./cloud-shared-responsibility-stack/index.md)**
    ...
    <!-- ![Shared Responsibility Across IaaS, PaaS, SaaS, and FaaS](./cloud-shared-responsibility-stack/cloud-shared-responsibility-stack.png) -->
...
-   **[Six-Component Model of an Information System](./six-component-model/index.md)**
    ...
    <!-- ![Six-Component Model of an Information System](./six-component-model/six-component-model.png) -->
...
-   **[State Diagram for "Loan Application Status](./loan-application-state-diagram/index.md)**
    ...
    <!-- ![State Diagram for "Loan Application Status](./loan-application-state-diagram/loan-application-state-diagram.png) -->

    State Diagram for "Loan Application Status

-   **[STRIDE Overlay on a Simple Web Application](./stride-threat-model-overlay/index.md)**

    <!-- ![STRIDE Overlay on a Simple Web Application](./stride-threat-model-overlay/stride-threat-model-overlay.png) -->
...
-   **[The Enterprise Systems Landscape with ERP at the Center](./enterprise-systems-landscape/index.md)**
    ...
    <!-- ![The Enterprise Systems Landscape with ERP at the Center](./enterprise-systems-landscape/enterprise-systems-landscape.png) -->
...
-   **[The ERP Implementation Timeline with Cutover](./erp-implementation-timeline/index.md)**
    ...
    <!-- ![The ERP Implementation Timeline with Cutover](./erp-implementation-timeline/erp-implementation-timeline.png) -->
...
-   **[The Project Triangle (Scope, Time, Cost — and Quality in the Middle)](./project-triangle/index.md)**
    ...
    <!-- ![The Project Triangle (Scope, Time, Cost — and Quality in the Middle)](./project-triangle/project-triangle.png) -->
